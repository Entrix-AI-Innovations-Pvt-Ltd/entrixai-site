    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-neutral-950/70">
        <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
          ...
          <a
            href="#waitlist"
            className="rounded-xl bg-white/10 px-4 py-2 text-sm hover:bg-white/20 md:inline-block"
          >
            Join waitlist
          </a>
        </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 pt-20 pb-16 md:pt-28 md:pb-24">
          ...
          <p className="mt-4 max-w-2xl text-neutral-300 md:text-lg">
            Budha is our flagship product: a fast, privacy‑first assistant that remembers what works
            for you— then guides you back to your best self.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center rounded-3xl border border-white/10 bg-white/5 p-6 md:p-10">
          <div>
            ...
            <p className="mt-3 text-neutral-300">
              A layered cognitive stack: Reflex Core for low‑latency actions, Cognition Layer for
              deep work, and a Dynamic Personality Core that adapts to your state. Powered by
              Compressed Thought Vectors (CTVs) and an Emotional Recall Engine (ERE).
            </p>
      ...
      >
        <h3 id="waitlist-title" className="text-xl md:text-3xl font-semibold">
          Be first to try Budha
        </h3>
        <p className="mt-2 text-neutral-300">
          We’re inviting early users in small waves. Drop your email and we’ll reach out with
          access.
        </p>
        <form
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-10 text-sm text-neutral-400">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <p>
              © {new Date().getFullYear()} Entrix AI Innovations Pvt. Ltd. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <a href="mailto:hello@entrixai.com" className="hover:text-neutral-200">
                hello@entrixai.com
              </a>
